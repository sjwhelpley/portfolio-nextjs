...
const experiences = [
  {
    ...
    description: `Work across large, legacy React/Rails codebases on the Self-Serve team, implementing features and resolving defects for company administration workflows.
    ...
    technologies: ["TypeScript", "React", "Redux", "Next.js", "Ruby on Rails"],
  },
  {
    ...
    description: `Managed a team of 5 developers, contributing to sprint planning, task allocation, and budget management, improving coordination and communication with project managers.
  ...
  return (
    ...
    >
      ...
      <div className="col-span-6">
        <p className="font-bold text-lg text-white group-hover:text-accent">
    ...
    <Section
      ...
      content={
        <>
          ...
          <a
            href="/Samantha_Whelpley_Resume.pdf"
            target="_blank"
            className="group font-bold text-white cursor-pointer hover:text-accent"
          >
            Full Resume{" "}
            <FontAwesomeIcon
              icon={faSquareArrowUpRight}
